...
import { StatusBar, StyleSheet, Text, View, SafeAreaView, TextInput, FlatList, Image,  Animated, Easing, TouchableOpacity } from 'react-native';
...
export default class TestClass extends React.Component{
    ...
    App = (props) => {
        const renderItem = ({ item }) => (
            <TouchableOpacity style={styles.individualStockContainer}>
